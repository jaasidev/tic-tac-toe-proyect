...
export function Finish ({ last, gana, restart }) {
  ...
  const personalizacion = isShow ? 'absolute w-80 h-60 sm:w-[500px] sm:h-96 flex flex-col justify-evenly border m-auto inset-0 items-center bg-slate-900 border-slate-600 rounded-lg' : 'hidden'
